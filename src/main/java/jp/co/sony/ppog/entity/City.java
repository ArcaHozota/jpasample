...
@NamedQuery(name = "City.updateById", query = "update City c set c.name =:name, c.countryCode =:countryCode, c.district =:district, c.population =:population, c.isDeleted =:isDeleted where c.id =:id")
